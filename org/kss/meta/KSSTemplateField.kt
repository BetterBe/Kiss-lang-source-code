...
class KSSTemplateField : KSSNode {
    ...
    val context : KSSParser.TemplateContext
    ...
    constructor(ctx : KSSParser.TemplateContext){
        context = ctx
        populateChildren()
    }

    fun applyToNode(node : KSSNode, styler : KSSStyler){
